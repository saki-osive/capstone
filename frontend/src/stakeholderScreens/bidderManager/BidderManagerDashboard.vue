        ...
        <v-row>
            <v-col cols="12" md="6">
                <v-card flat>
                    ...
                    <v-card-text class="pt-0">
                        <div class="title font-weight-light mb-2">Active Bidders</div>
                        <div
                            class="subheading font-weight-light grey--text"
                        >Active Bidders in month of July</div>
            ...
            <v-col cols="12" md="4">
                <v-card flat class="mt-4 mx-auto" max-width="400">
                    ...
                    <v-card-text class="pt-0">
                        <div class="title font-weight-light mb-2">Total Bidders</div>
                        <div
                            class="subheading font-weight-light grey--text"
        ...
        <v-row>
            <v-col cols="12" sm="6" lg="3">
                <v-card flat>
                    <v-progress-circular
                        ...
                        :value="80"
                        color="teal"
                    >Bidders Approved</v-progress-circular>
                </v-card>
            </v-col>
            ...
            <v-col cols="12" sm="6" lg="3">
                <v-progress-circular
                    ...
                    value="3"
                    color="red"
                >Bidders Suspended</v-progress-circular>
            </v-col>
            <v-col cols="12" sm="6" lg="3">
                <v-card flat>
                    <v-progress-circular
                        ...
                        :value="Pvalue"
                        color="green"
                    >New Bidders added</v-progress-circular>
                </v-card>
            </v-col>
