    ...
    <v-row>
      <v-col cols="12">
        ...
        >
          ...
          >120 New Custom Clearnace</v-card
          >
          <v-card class="ma-3 pa-6" outlined tile
    ...
    <v-row>
      <v-col cols="12" md="6">
        <v-card flat>
          ...
          <v-card-title class="ml-12 pl-12">
           Freight Orders Appeared for Custom Clearance
          </v-card-title>
        </v-card>
      </v-col>
      ...
      <v-row>
        <v-card flat>
          <v-row>
            ...
            <v-col cols="12" sm="6" lg="3" class="ml-12 pl-12 ">
              <v-progress-circular
                  :rotate="360"
                  :size="200"
                  :width="25"
