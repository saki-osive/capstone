        ...
        <v-row>
            <v-col cols="12">
                <v-row align="start" justify="center" class="grey lighten-5" style="height: 100px;">
                    <v-card class="ma-3 pa-6" outlined tile>19 Technical Experts</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>19 Financial Experts</v-card>

                    <v-card class="ma-3 pa-6" outlined tile>225 Pending reviews</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>22 Active Lots</v-card>
            ...
            <v-col cols="12" md="6">
                <v-card flat>
                    ...
                    <v-card-text class="pt-0">
                        <div class="title font-weight-light mb-2">Pending Products</div>
                        <div
                            class="subheading font-weight-light grey--text"
                        >Pending Products in month of July</div>
            ...
            <v-col cols="12" md="4">
                <v-card flat class="mt-4 mx-auto" max-width="400">
                    ...
                    <v-card-text class="pt-0">
                        ...
                        <div
                            class="subheading font-weight-light grey--text"
                        >Total Products in june and july</div>
                        <v-divider class="my-2"></v-divider>
                        <v-icon class="mr-2" small>mdi-clock</v-icon>
                        <span
                            class="caption grey--text font-weight-light"
        ...
        <v-row class="mx-auto">
            <v-col cols="12" sm="6" lg="3">
                <v-card flat class="pl-12">
                    <v-progress-circular
                        ...
                        :value="80"
                        color="teal"
                    >Products Reviewed</v-progress-circular>
                </v-card>
            </v-col>
            ...
            <v-col cols="12" sm="6" lg="3" class="ml-12">
                <v-progress-circular
                    ...
                    value="3"
                    color="red"
                >Products Expired </v-progress-circular>
            </v-col>
