        ...
        <v-row>
            <v-col cols="12">
                <v-row align="start" justify="center" class="grey lighten-5" style="height: 100px;">
                    <v-card class="ma-3 pa-6" outlined tile>110 New Users added</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>25 Pending reviews</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>7 accounts suspended</v-card>
                </v-row>
            </v-col>
        </v-row>
        ...
        <v-row>
            <v-col cols="12" md="6">
                <v-card flat>
                    ...
                    <v-card-text class="pt-0">
                        ...
                        >Active Users in month of July</div>
            ...
            <v-col cols="12" md="4">
                <v-card flat class="mt-4 mx-auto" max-width="400">
                    ...
                    <v-card-text class="pt-0">
                        <div class="title font-weight-light mb-2">Total Users</div>
                        <div
                            class="subheading font-weight-light grey--text"
                        >Total Users registered in june and july</div>
                        <v-divider class="my-2"></v-divider>
                        <v-icon class="mr-2" small>mdi-clock</v-icon>
                        <span
                            class="caption grey--text font-weight-light"
        ...
        <v-row class="mx-auto">
            <v-col cols="12" sm="6" lg="3">
                <v-card flat class="pl-12">
                    <v-progress-circular
                        ...
                        :value="80"
                        color="teal"
                    >Users Approved</v-progress-circular>
                </v-card>
            </v-col>
            ...
            <v-col cols="12" sm="6" lg="3" class="ml-12">
                <v-progress-circular
                    ...
                    value="3"
                    color="red"
                >Accounts Suspended</v-progress-circular>
            </v-col>
