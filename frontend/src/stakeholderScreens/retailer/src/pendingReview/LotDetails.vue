        ...
        <v-card class="mx-auto mb-0 pb-0">
            ...
            <v-container class="pl-16 ml-16">
                            <div >
                                ...
                                <v-row>
                                    <v-col cols="5" align="right">Type of Productding System:</v-col>
            ...
            <div class="text-center">
                ...
                <v-btn class="mx-4" small :to="{ name: 'AcceptLot'}">Submit and Next</v-btn>
                <v-btn class="mx-4" small @click.stop="Reject= true">Reject Lot</v-btn>
