...
<v-card>
      ...
      <div class="title font-weight-light mb-2">Active Lots</div>
      <div class="subheading font-weight-light grey--text">Active lots in month of July </div>
 ...
 <v-card
  ...
  >
    ...
    <v-card-text class="pt-0">
      <div class="title font-weight-light mb-2">Total Lots</div>
      <div class="subheading font-weight-light grey--text">Total lots created in june and july </div>
      <v-divider class="my-2"></v-divider>
      <v-icon
        class="mr-2"
        small
