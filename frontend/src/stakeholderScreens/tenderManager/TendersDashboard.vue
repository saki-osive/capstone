...
<v-card>
      ...
      <div class="subheading font-weight-light grey--text">Active tenders in month of July </div>
 ...
 <v-card
  ...
  >
    ...
    <v-card-text class="pt-0">
      ...
      <div class="subheading font-weight-light grey--text">Total tenders created in june and july </div>
      <v-divider class="my-2"></v-divider>
      <v-icon
        class="mr-2"
        small
